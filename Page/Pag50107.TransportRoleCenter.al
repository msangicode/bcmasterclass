page 50107 "Transport Role Center"
{
    ...
    actions
    {
        ...
        area(sections)
        {
            group(Booking)
            {
                ...
                action("Posted Booking List")
                {
                    ApplicationArea = Service;
                    Caption = 'Posted Booking List';
                    RunObject = page "Posted Booking List";
                }
        ...
        area(Creation)
        {
            action(Setup)
            {
                RunObject = page "Transport Setup";
                ApplicationArea = Service;
...
profile "Trasport Manager"
{
    Description = 'Profile Display Name';
    RoleCenter = "Transport Role Center";
    Caption = 'Trasport Manager';
}
